...
async function fetchData() {
   try {
     ...
     const response = await fetch('https://api.example.com/data'); // Waits for the fetch request to complete and retrieves the response
     ...
     console.error('There was a problem with the fetch operation:', error); // Catches and logs any errors that occurred during the fetch operation
   }
 }
 
 fetchData(); // Executes the async function to fetch data
 ...
 */
 ...
 function fetchData() {
   fetch('https://api.example.com/data') // Initiates a fetch request to the provided URL
 ...
 fetchData(); // Executes the function to fetch data
